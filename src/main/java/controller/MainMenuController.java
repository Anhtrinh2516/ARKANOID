...
public class MainMenuController {
    ...
    @FXML
    private Circle level1, level2, level3, level4, level5, level6;
    @FXML
    private Circle level7, level8, level9, level10, level11, level12;
    @FXML
    private Circle level13, level14, level15, level16;
    ...
    @FXML
    private Label label13, label14, label15, label16;
